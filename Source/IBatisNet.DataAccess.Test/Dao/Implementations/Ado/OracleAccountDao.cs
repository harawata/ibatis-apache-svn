...
namespace IBatisNet.Test.Dao.Implementations.Ado
{
	...
	/// </summary>
	public class OracleAccountDao : BaseDao, IAccountDao
	{
		// Oracle
		...
		public void Update(Account account)
		{
			...
			{
				throw new DataAccessException("Error executing OracleAccountDao.Update. Cause :" + e.Message, e);
			}
			finally
			{
				command.Dispose();
		...
		public void Delete(Account account)
		{
			...
			{
				throw new DataAccessException("Error executing OracleAccountDao.Delete. Cause :" + e.Message, e);
			}
			finally
			{
				command.Dispose();
		...
		private Account PopulateAccount(IDataReader dataReader)
		{
			...
			account.Id = int.Parse(dataReader["Account_Id"].ToString());

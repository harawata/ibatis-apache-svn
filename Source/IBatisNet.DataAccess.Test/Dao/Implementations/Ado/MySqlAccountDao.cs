...
{
	/// <summary>
	/// Description résumée de MySqlAccountDao.
	/// </summary>
	public class MySqlAccountDao : BaseDao, IAccountDao
	{
		// MySql
		...
		public void Create(Account account)
		{
			...
			{
				throw new DataAccessException("Error executing MySqlAccountDao.Create. Cause :" + e.Message, e);
			}
			finally
			{
				command.Dispose();
		...
		public void Update(Account account)
		{
			...
			{
				throw new DataAccessException("Error executing MySqlAccountDao.Update. Cause :" + e.Message, e);
			}
			finally
			{
				command.Dispose();
		...
		public Account GetAccountById(int accountID)
		{
			...
			{
				throw new DataAccessException("Error executing MySqlAccountDao.GetAccountById. Cause :" + e.Message, e);
			}
			finally
			{
				command.Dispose();

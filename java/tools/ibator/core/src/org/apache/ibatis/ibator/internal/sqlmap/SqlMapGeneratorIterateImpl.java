...
public class SqlMapGeneratorIterateImpl implements SqlMapGenerator {
     ...
     */
    public List<GeneratedXmlFile> getGeneratedXMLFiles(IntrospectedTable introspectedTable,
     ...
     * (non-Javadoc)
     * 
     * @see org.apache.ibatis.ibator.api.SqlMapGenerator#getSqlMapNamespace(org.apache.ibatis.ibator.config.FullyQualifiedTable)
     */

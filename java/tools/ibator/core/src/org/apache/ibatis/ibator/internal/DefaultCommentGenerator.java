...
public class DefaultCommentGenerator implements CommentGenerator {
    ...
    public void addFieldComment(Field field, FullyQualifiedTable table, String columnName) {
        ...
        field.addJavaDocLine(" * This field was generated by iBATOR for iBATIS."); //$NON-NLS-1$
    ...
    public void addClassComment(InnerClass innerClass, FullyQualifiedTable table) {
        ...
        innerClass.addJavaDocLine(" * This class was generated by iBATOR for iBATIS."); //$NON-NLS-1$
    ...
    public void addEnumComment(InnerEnum innerEnum, FullyQualifiedTable table) {
        ...
        innerEnum.addJavaDocLine(" * This enum was generated by iBATOR for iBATIS."); //$NON-NLS-1$
    ...
    public void addGetterComment(Method method, FullyQualifiedTable table, String columnName) {
        ...
        method.addJavaDocLine(" * This method was generated by iBATOR for iBATIS."); //$NON-NLS-1$
    ...
    public void addComment(XmlElement xmlElement) {
        ...
        xmlElement.addElement(new TextElement(
                "  WARNING - This element is automatically generated by iBATOR for iBATIS, do not modify.")); //$NON-NLS-1$

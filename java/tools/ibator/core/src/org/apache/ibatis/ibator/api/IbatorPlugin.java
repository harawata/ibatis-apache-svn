...
public interface IbatorPlugin {
     ...
     */
    List<GeneratedJavaFile> modelGenerateAdditionalJavaFiles(IntrospectedTable introspectedTable);
    ...
    List<GeneratedXmlFile> sqlMapGenerateAdditionalXmlFiles(IntrospectedTable introspectedTable);
    ...
    List<GeneratedJavaFile> daoGenerateAdditionalJavaFiles(IntrospectedTable introspectedTable);

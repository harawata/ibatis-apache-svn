...
public class ExampleClause {
	...
	private static final List<ExampleClause> clauses;
	...
	static {
		List<ExampleClause> list = new ArrayList<ExampleClause>();
	...
	public static Iterator<ExampleClause> getAllExampleClauses() {

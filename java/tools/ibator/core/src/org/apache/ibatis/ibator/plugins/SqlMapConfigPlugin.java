 ...
 * SQL maps generated by ibator.  This demonstrates hooking into the ibator
 * code generation lifecycle and generating additional XML files.
 * <p>
...
public class SqlMapConfigPlugin extends IbatorPluginAdapter {
    ...
    public boolean validate(List<String> warnings) {
        ...
        if (!StringUtility.stringHasValue(properties.getProperty("targetProject"))) { //$NON-NLS-1$
            warnings.add("The SqlMapConfig plugin requires the targetProject property");
            valid = false;
        }
        
        if (!StringUtility.stringHasValue(properties.getProperty("targetPackage"))) { //$NON-NLS-1$
            warnings.add("The SqlMapConfig plugin requires the targetPackage property");
            valid = false;
        }

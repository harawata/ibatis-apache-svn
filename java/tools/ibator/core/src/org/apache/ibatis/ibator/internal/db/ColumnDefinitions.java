...
public class ColumnDefinitions {
	...
	public ColumnDefinitions() {
		super();
		primaryKeyColumns = new ArrayList<ColumnDefinition>();
        baseColumns = new ArrayList<ColumnDefinition>();
        blobColumns = new ArrayList<ColumnDefinition>();
	}
	...
	public void addPrimaryKeyColumn(String columnName) {
        ...
        Iterator<ColumnDefinition> iter = baseColumns.iterator();
        while (iter.hasNext()) {

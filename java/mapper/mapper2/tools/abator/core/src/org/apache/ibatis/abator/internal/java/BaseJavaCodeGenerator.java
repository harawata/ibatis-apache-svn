...
public abstract class BaseJavaCodeGenerator {
	...
	public String getFieldComment(FullyQualifiedTable table, String columnName) {
		...
		newLine(comment);
		indent(comment, 1);
		comment.append(" * This field was generated by Abator for iBATIS."); //$NON-NLS-1$
		newLine(comment);
		indent(comment, 1);
		comment.append(" * This field corresponds to the database column "); //$NON-NLS-1$
	...
	public String getFieldComment(FullyQualifiedTable table) {
		...
		newLine(comment);
		indent(comment, 1);
		comment.append(" * This field corresponds to the database table "); //$NON-NLS-1$
		comment.append(table.getFullyQualifiedTableName());
		newLine(comment);
		indent(comment, 1);
		comment.append(" *"); //$NON-NLS-1$
	...
	public String getGetterMethodComment(FullyQualifiedTable table, ColumnDefinition columnDefinition) {
		...
		newLine(comment);
		indent(comment, 1);
		comment.append(" * This method was generated by Abator for iBATIS."); //$NON-NLS-1$
		newLine(comment);
		indent(comment, 1);
		comment.append(" * This method returns the value of the database column "); //$NON-NLS-1$
		comment.append(table.getFullyQualifiedTableName());
		comment.append('.');
		...
		newLine(comment);
		indent(comment, 1);
		comment.append(" * @return the value of "); //$NON-NLS-1$
		comment.append(table.getFullyQualifiedTableName());
		comment.append('.');
		comment.append(columnDefinition.getColumnName());
		newLine(comment);
	...
	public String getSetterMethodComment(FullyQualifiedTable table, ColumnDefinition columnDefinition) {
		...
		newLine(comment);
		indent(comment, 1);
		comment.append(" * This method sets the value of the database column "); //$NON-NLS-1$
		comment.append(table.getFullyQualifiedTableName());
		comment.append('.');
		comment.append(columnDefinition.getColumnName());
		newLine(comment);
		...
		newLine(comment);
		indent(comment, 1);
		comment.append(" * @param "); //$NON-NLS-1$
		comment.append(columnDefinition.getJavaProperty());
		comment.append(" the value for "); //$NON-NLS-1$
		comment.append(table.getFullyQualifiedTableName());
		comment.append('.');
		comment.append(columnDefinition.getColumnName());
		newLine(comment);
	...
	public String getMethodComment(FullyQualifiedTable table) {
		...
		newLine(comment);
		indent(comment, 1);
		comment.append(" * This method corresponds to the database table "); //$NON-NLS-1$
		comment.append(table.getFullyQualifiedTableName());
		newLine(comment);
		indent(comment, 1);
		comment.append(" *"); //$NON-NLS-1$
	...
	public String getMethodComment(FullyQualifiedTable table, String deprecatedComment) {
		StringBuffer comment = new StringBuffer();
		...
		newLine(comment);
		indent(comment, 1);
		comment.append(" * @deprecated "); //$NON-NLS-1$
		comment.append(deprecatedComment);
		newLine(comment);
		indent(comment, 1);
		comment.append(" */"); //$NON-NLS-1$

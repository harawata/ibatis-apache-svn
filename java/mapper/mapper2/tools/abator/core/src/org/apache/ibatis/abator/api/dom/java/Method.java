...
public class Method extends JavaElement {
    ...
    public void addGetterComment(FullyQualifiedTable table, ColumnDefinition columnDefinition) {
    	StringBuffer sb = new StringBuffer();
    ...
    public void addSetterComment(FullyQualifiedTable table, ColumnDefinition columnDefinition) {
    	StringBuffer sb = new StringBuffer();

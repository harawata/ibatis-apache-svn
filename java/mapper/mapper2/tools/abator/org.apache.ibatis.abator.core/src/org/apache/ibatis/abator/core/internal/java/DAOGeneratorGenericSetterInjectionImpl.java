...
public class DAOGeneratorGenericSetterInjectionImpl extends
	...
	static {
		...
		template
				.addMethod("public void setSqlMapClient(SqlMapClient sqlMapClient) { this.sqlMapClient = sqlMapClient;}"); //$NON-NLS-1$
		template.addMethod("public SqlMapClient getSqlMapClient() { return sqlMapClient;}"); //$NON-NLS-1$

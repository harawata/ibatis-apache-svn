...
CREATE TABLE ORDERS (
    ...
    ORD_ACC_ID           INTEGER NOT NULL,
    ORD_DATE             DATETIME NOT NULL,
    ORD_CARD_TYPE        VARCHAR,
    ORD_CARD_NUMBER      VARCHAR,
    ORD_CARD_EXPIRY      VARCHAR,
    ORD_STREET           VARCHAR,
    ORD_CITY             VARCHAR,
    ORD_PROVINCE         VARCHAR,
    ORD_POSTAL_CODE      VARCHAR,
    ORD_FAVOURITE_LINE   INTEGER,
    PRIMARY KEY (ORD_ID)
);

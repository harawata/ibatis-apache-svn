...
namespace Apache.Ibatis.DataMapper.SqlClient.Test.Fixtures.Mapping
{
    ...
    public class DynamicPrependTest : BaseTest
    {
        ...
        public void TestIterateWithPrepend1()
        {
            ...
            IList list = dataMapper.QueryForList("DynamicIterateWithPrepend1", parameters);
        ...
        public void TestIterateWithPrepend2()
        {
            ...
            IList list = dataMapper.QueryForList("DynamicIterateWithPrepend2", parameters);
        ...
        public void TestIterateWithPrepend3()
        {
            ...
            IList list = dataMapper.QueryForList("DynamicIterateWithPrepend3", parameters);
        ...
        {
            IList list = dataMapper.QueryForList("DynamicWithPrepend", null);
        ...
        public void TestGetAccountsDynamic()
        {
            ...
            IList list = dataMapper.QueryForList("GetAccountsDynamic", map);
        ...
        public void TestDynamicSelectByIntLong()
        {
            ...
            IList list = dataMapper.QueryForList("DynamicSelectByIntLong", search);
            ...
            list = null;
            list = dataMapper.QueryForList("DynamicSelectByIntLong", search);
        ...
        public void TestJIRA11()
        {
            ...
            IList list = dataMapper.QueryForList("Jira-IBATISNET-11", search);
        ...
        public void TestJIRA29()
        {
            ...
            Order order = dataMapper.QueryForObject("SelectOrderByDate", param) as Order;
            ...
            order = dataMapper.QueryForObject("SelectOrderByDateDynamic", param) as Order;
        ...
        public void Test2ForJIRA29()
        {
            ...
            Account testAccount = dataMapper.QueryForObject("SelectAccountJIRA29", param) as Account;

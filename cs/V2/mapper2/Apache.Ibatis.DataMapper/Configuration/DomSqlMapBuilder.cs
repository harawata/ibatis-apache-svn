...
namespace Apache.Ibatis.DataMapper.Configuration
{
    ...
    //    /// </summary>
    //    /// <param name="resource">A valid uri.</param>
    //    /// <returns>An ISqlMapper instance.</returns>
    ...
    //                ISession session = new SqlMapSession(_configScope.SqlMapper);
    ...
    //        ISession session = new SqlMapSession(configScope.SqlMapper);
    ...
    //    {
    //        return Assembly.GetExecutingAssembly().GetManifestResourceStream("Apache.Ibatis.DataMapper." + schemaResourceKey); 
    //    }
    ...
    //    }
        ...
        {
            return string.Empty;// MAPPING_NAMESPACE_PREFIX + ":" + elementName.

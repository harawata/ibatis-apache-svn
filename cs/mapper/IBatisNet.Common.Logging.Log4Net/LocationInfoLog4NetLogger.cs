...
{
	/// <summary>
	/// Specialized Log4NetLogger that correctly preserves location information.
	/// </summary>
	/// <remarks>
	...
	/// information should be gathered relative to where log4net.ILog.Debug() was called. In IBatisNet, 
	/// log4net.ILog.Debug() is called in IBatisNet.Common.Logging.Impl.Log4NetLogger. This means that
	/// the location information will indicate that IBatisNet.Common.Logging.Impl.Log4NetLogger always made
	/// the call to log4net.ILog.Debug(). We need to know where IBatisNet.Common.Logging.ILog.Debug()
